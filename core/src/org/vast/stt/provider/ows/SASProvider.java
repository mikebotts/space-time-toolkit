 ...
 * @version 1.0
 */
public class SASProvider extends OWSProvider
{
    protected SASLayerCapabilities layerCaps;
  ...
  /*      request.getTime().setBaseTime(timeExtent.getAdjustedLagTime());
    ...
    {
        this.layerCaps = (SASLayerCapabilities)caps.getLayers().get(0);
 ...
 /*       if (!layerCaps.getBboxList().isEmpty())
    ...
    @Override
    public SASLayerCapabilities getLayerCapabilities()
    {
