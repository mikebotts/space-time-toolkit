 ...
 * @version 1.0
 */
public class AnimationSpinner extends TimeSpinner implements SelectionListener{

	//private TimeZoneCombo tzCombo;
	//protected Button rtBtn;

	public AnimationSpinner(Composite parent, String label) {
		super();
...
//    	downBtn.addFocusListener(this);
	...
	private void ensureTextWidth(StyledText text){
		GridData gridData = new GridData();
