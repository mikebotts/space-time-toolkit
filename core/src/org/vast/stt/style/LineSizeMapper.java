 ...
 * @version 1.0
 */
public class LineSizeMapper extends DimensionMapper
{
	LineSegmentGraphic lineSeg;
    
    
    public LineSizeMapper(int dimensionIndex, LineSegmentGraphic lineSeg, MappingFunction mappingFunction)
    {
