...
/**
 * <p><b>Title:</b>
 * SPS Status Provider Reader
 * </p>
 *
 * <p><b>Description:</b><br/>
 * Read SPS Status Provider options from project XML 
 * </p>
 *
 ...
 * @version 1.0
 */
public class SPSStatusProviderReader extends XMLReader implements XMLModuleReader
{
    protected OWSUtils owsUtils = new OWSUtils();
    
    
    public SPSStatusProviderReader()
    {        
    }
    ...
    {
    	SPSStatusProvider provider = new SPSStatusProvider();
        ...
        try
        {
            ...
            provider.setGetStatusRequest((GetStatusRequest)request);
        }
        catch (Exception e)
        {
            e.printStackTrace();
