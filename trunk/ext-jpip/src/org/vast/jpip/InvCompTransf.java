...
//	    block0.uly = block2.uly = block1.uly = blk.uly;
	    block0 = new DataBlkInt(blk.ulx, blk.uly, blk.w, blk.h);
	    block1 = new DataBlkInt(blk.ulx, blk.uly, blk.w, blk.h);
	    block2 = new DataBlkInt(blk.ulx, blk.uly, blk.w, blk.h);
            ...
            block0 = (DataBlkInt)src.getInternCompData(block0, 0);
            data0  = (int[]) block0.getData();
            block2 = (DataBlkInt)src.getInternCompData(block2, 1);
            data2 = (int[]) block2.getData();
            block1 = (DataBlkInt)src.getInternCompData(block1, 2);
            data1 = (int[]) block1.getData();
