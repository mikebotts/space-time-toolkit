...
public class BlkImgDataSrcImageProducer implements ImageProducer {
     ...
     * */
    public BlkImgDataSrcImageProducer(BlkImgDataSrc src, int numComps) {
        int i;
     ...
     * image producer.
     * */
    public static Image createImage(BlkImgDataSrc src, int numComps) {
        // Use the system toolkit's createImage method
        return Toolkit.getDefaultToolkit().
            createImage(new BlkImgDataSrcImageProducer(src, numComps));
    }
     ...
     * image producer.
     * */
    public static Image createImage(BlkImgDataSrc src, Component c, int numComps){
...
//                                  src.getCompImgHeight(0));
            cons[i].setDimensions(src.getImgWidth(),
                                  src.getImgHeight());
