...
public class TimeExtent
{
    ...
    public TimeExtent(double baseJulianTime, double timeBiasSeconds, double timeStepSeconds,
                        double leadTimeDeltaSeconds, double lagTimeDeltaSeconds){
    ...
    public double[] getTimes(){
        ...
        for (int i=0; i<steps; i++) times[i] = time - i*timeStep;
        return times;
    }
